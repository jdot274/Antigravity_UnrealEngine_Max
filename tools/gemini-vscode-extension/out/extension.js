...
function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('antigravity.explainCode', () => handleCommand(geminiService, 'Explain this code')), vscode.commands.registerCommand('antigravity.generateTests', () => handleCommand(geminiService, 'Generate unit tests for this code')), vscode.commands.registerCommand('antigravity.refactorCode', () => handleCommand(geminiService, 'Refactor this code for performance and readability')), vscode.commands.registerCommand('antigravity.askGemini', () => handleCustomQuery(geminiService)));
}
...
async function handleCommand(service, promptPrefix) {
...
async function handleCustomQuery(service) {
...
class GeminiService {
    ...
    async streamResponse(prompt) {
        ...
        const model = config.get('model') || 'gemini-pro';
        if (!apiKey) {
